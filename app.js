...
const RECIPES = [
  {
    ...
    ingredients: [
      ...
      { amount: "pinch",        item: "crushed red pepper flakes" },
      { amount: "1 tsp",        item: "neutral oil (grapeseed or avocado), for cooking" },
    ],
    steps: [
      {
