...
const RECIPES = [
  {
    ...
    ingredients: [
      ...
      { amount: "0.9 stalks", item: "green garlic (white and light green parts), finely minced" },
      { amount: "0.2 cups",   item: "shallots, finely minced" },
      { amount: "0.1 cups",   item: "fresh mint leaves, finely chopped" },
      { amount: "0.1 cups",   item: "fresh cilantro, finely chopped" },
      { amount: "0.1 thumb",  item: "fresh ginger, grated" },
      { amount: "0.2",        item: "limes, zested and juiced" },
      { amount: "0.1 cups",   item: "plain full-fat yogurt" },
      { amount: "0.4 large",  item: "eggs" },
      { amount: "0.2 cups",   item: "panko breadcrumbs" },
      { amount: "0.2 tbsp",   item: "kosher salt" },
      { amount: "0.1 tbsp",   item: "black pepper, freshly ground" },
      { amount: "0.1 tbsp",   item: "ground cumin" },
      { amount: "0.1 tbsp",   item: "ground coriander" },
      { amount: "0.1 tsp",    item: "crushed red pepper flakes" },
      { amount: "0.3 tbsp",   item: "neutral oil (grapeseed or avocado), for cooking" },
    ],
    steps: [
      {
